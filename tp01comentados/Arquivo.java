...
class Arquivo
{
/*Obs: nao consegui formatar a saida de alguns casos que ficavam com um .0 adicional utilizando somente as funções permitidas no enunciado do TP01
*/
    public static void main (String args[]) throws Exception
    {
        int n = MyIO.readInt();
//abrir o arquivo para escrever nele
...
//abrir o arquivo para leitura
        ...
        raf.seek(tam);
//while com a condicao de que o ponteiro chegue na primeira linha
