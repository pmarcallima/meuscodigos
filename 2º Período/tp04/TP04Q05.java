 ...
 */
class ArvoreBinaria extends Log
{
	No raiz;
	/**
	 * Construtor sem parametros
	...
	/**
	* Método inicializador do treeSort recursivo.
	*/
	void treeSort()
	{
		treeSort(raiz);
	...
	/**
	* Método recursivo de treeSort
	* @param i Nó atual na árvore.
	*/
	void treeSort(No i)
	{
		if(i != null)
...
//Metodo que constrói o arquivo log da ordenação por seleção
   public void log()
   {
	   Arq.openWrite("815336_treeSort.txt");
	   Arq.print("815336\t");
	   Arq.print(cmp);
	   Arq.print("\t");
...
class TP04Q05 extends Jogador
{
	 public static void main(String args[]) throws Exception
  {
	   ...
	   int i = 0;
	    ...
	    ab.inicio = new Date().getTime();
	    ab.treeSort();
	    ab.fim = new Date().getTime();
	    ab.log();
